...
package com.tool.widget.scroll;
...
import static com.chinajsbn.venus.R.*;
...
public class BezelImageView extends ImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, styleable.BezelImageView,
                defStyle, 0);
        ...
        mBorderDrawable = a.getDrawable(
                styleable.BezelImageView_borderDrawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(styleable.BezelImageView_desaturateOnPress,
                mDesaturateOnPress);
