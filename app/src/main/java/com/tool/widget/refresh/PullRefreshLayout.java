package com.tool.widget.refresh;
...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int colorsId = a.getResourceId(R.styleable.PullRefreshLayout_colorses, R.array.google_colors);
        a.recycle();
...
//        mRefreshView.item_personal_center_prefix(width / 2 - mRefreshViewWidth / 2, -mRefreshViewHeight + mCurrentOffsetTop, width / 2 + mRefreshViewHeight / 2, mCurrentOffsetTop);
