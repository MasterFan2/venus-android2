package com.tool.widget.velocimeter;
...
import com.tool.widget.velocimeter.painter.bottom.BottomVelocimeterPainter;
import com.tool.widget.velocimeter.painter.bottom.BottomVelocimeterPainterImp;
import com.tool.widget.velocimeter.painter.digital.Digital;
import com.tool.widget.velocimeter.painter.digital.DigitalBlurImp;
import com.tool.widget.velocimeter.painter.digital.DigitalImp;
import com.tool.widget.velocimeter.painter.inside.InsideVelocimeterMarkerPainter;
import com.tool.widget.velocimeter.painter.inside.InsideVelocimeterMarkerPainterImp;
import com.tool.widget.velocimeter.painter.inside.InsideVelocimeterPainterImp;
import com.tool.widget.velocimeter.painter.needle.LineBlurPainter;
import com.tool.widget.velocimeter.painter.needle.NeedlePainter;
import com.tool.widget.velocimeter.painter.needle.NeedlePainterImp;
import com.tool.widget.velocimeter.painter.progress.BlurProgressVelocimeterPainter;
import com.tool.widget.velocimeter.painter.progress.ProgressVelocimeterPainter;
import com.tool.widget.velocimeter.painter.progress.ProgressVelocimeterPainterImp;
import com.tool.widget.velocimeter.painter.velocimeter.InternalVelocimeterPainter;
import com.tool.widget.velocimeter.painter.velocimeter.InternalVelocimeterPainterImp;
...
public class VelocimeterView extends View {
  ...
  private int max = 100;
  private float value;
  private int duration = 500;//1000
  private long progressDelay = 200;//350
