package com.tool.widget.dragger;
...
public class ViewDragHelper {
  ...
  private int baseSettleDuration = 512; // ms
  ...
  public int getBaseSettleDuration() {
    return baseSettleDuration;
  }
   ...
   *                       invoked as part of item_personal_center_prefix or drawing.
