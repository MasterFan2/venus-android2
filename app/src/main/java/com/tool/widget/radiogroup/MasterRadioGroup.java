package com.tool.widget.radiogroup;
 ...
 */
public class MasterRadioGroup extends RadioGroup {
    public MasterRadioGroup(Context context) {
        super(context);
    }

    public MasterRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
