package com.tool.widget.dialog;
...
public class MTDialog {
    ...
    /**
     * Custom values for MTDialog gravity
     */
    public enum Gravity {
        TOP, BOTTOM, CENTER
    }
    ...
    /**
     * MTDialog base item_personal_center_prefix root view
     */
    private final ViewGroup rootView;

    /**
     * MTDialog content container which is a different item_personal_center_prefix rather than base item_personal_center_prefix
     */
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(MTDialog.this);
                        }
                    }
                });
            }
    ...
    /**
     * Convert DialogPlusGravity with content item_personal_center_prefix readable gravity
     *
     * @return the converted item_personal_center_prefix gravity that can be passed to the container
     */
    ...
    private View createView(LayoutInflater inflater) {
        if(backgroundResourceId != INVALID){
            holder.setBackground(backgroundResourceId);
        }
        ...
        if (adapter != null && holder instanceof HolderAdapter) {
            ...
            holderAdapter.setOnItemClickListener(new OnHolderListener() {
                ...
                public void onItemClick(Object item, View view, int position) {
                    ...
                    onItemClickListener.onItemClick(MTDialog.this, item, view, position);
                }
            });
        }
        return view;
    ...
    private void setClickListener(View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onClickListener.onClick(MTDialog.this, v);
            }
        });
    }
                    ...
                    case KeyEvent.ACTION_UP:
                        if (keyCode == KeyEvent.KEYCODE_BACK) {
                            if (onBackPressListener != null) {
                                onBackPressListener.onBackPressed(MTDialog.this);
                            }
                            if (isCancelable) {
                                onBackPressed(MTDialog.this);
                            }
                            return true;
                        }
                        break;
     ...
     *
     * @param MTDialog is the current dialog
     */
    public void onBackPressed(MTDialog MTDialog) {
        if (onCancelListener != null) {
            onCancelListener.onCancel(MTDialog.this);
        }
        dismiss();
    }
    ...
    public static class Builder {
        ...
        private int backgroundResourceID = INVALID;
        ...
        /**
         * Set the footer view using the id of the item_personal_center_prefix resource
         */
        ...
        /**
         * Set the header view using the id of the item_personal_center_prefix resource
         */
        ...
        public Builder setBackgroundResourceId(int resourceId){
         ...
         */
        public MTDialog create() {
            return new MTDialog(this);
        }
    }
}
