...
public class MasterListViewHeader extends LinearLayout {
	private LinearLayout mContainer;
	private MasterProgress mProgressBar;
	...
	public MasterListViewHeader(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public MasterListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
...
//		mArrowImageView = (ImageView)findViewById(R.id.xlistview_header_arrow);
		...
		mProgressBar = (MasterProgress)findViewById(R.id.xlistview_header_progressbar);
	}
