...
package com.tool.widget.scaleImageView;
...
import com.tool.widget.scaleImageView.decoder.CompatDecoderFactory;
import com.tool.widget.scaleImageView.decoder.DecoderFactory;
import com.tool.widget.scaleImageView.decoder.ImageDecoder;
import com.tool.widget.scaleImageView.decoder.ImageRegionDecoder;
import com.tool.widget.scaleImageView.decoder.SkiaImageDecoder;
import com.tool.widget.scaleImageView.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    private synchronized void onTilesInited(ImageRegionDecoder decoder, int sWidth, int sHeight, int sOrientation) {
        // If actual dimensions don't match the declared size, resetAll everything.
     ...
     * and want images to be resetAll when the user has moved to another page.
     */
