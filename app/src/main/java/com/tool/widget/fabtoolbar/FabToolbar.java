package com.tool.widget.fabtoolbar;
...
import com.tool.widget.fabtoolbar.animation.SupportAnimator;
import com.tool.widget.fabtoolbar.animation.ViewAnimationUtils;
import com.tool.widget.fabtoolbar.widget.RevealFrameLayout;
import com.tool.widget.floatActionButton.FloatingActionButton;
...
public class FabToolbar extends RevealFrameLayout {
	...
	private void init() {
		...
		button = (TextView) findViewById(R.id.fab);
