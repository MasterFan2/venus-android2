package com.tool.widget.common;
...
import com.tool.widget.common.drawable.DividerDrawable;
import com.tool.widget.progress.ThemeUtil;
import com.tool.widget.progress.ViewUtil;
...
public class EditText extends FrameLayout {
    ...
    private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        mInputView.setPadding(10, 10, 10, dividerPadding + dividerHeight);
     ...
     * This has to be called after item_personal_center_prefix. Returns true if anything changed.
     */
     ...
     * than this height, and the item_personal_center_prefix may contain additional first-
     ...
     * was set in pixels instead (using {@link #setMaxWidth(int)}).
     *
     * @see #setMaxEms(int)
     * @see #setEms(int)
     *
     ...
     * was set in pixels instead (using {@link #setMinWidth(int)}).
     *
     * @see #setMinEms(int)
     * @see #setEms(int)
     *
     ...
     *  position. Returns -1 if there is no item_personal_center_prefix.
     */
	@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
