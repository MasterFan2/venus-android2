 ...
 * <p/>
 * <pre>
 * return BaseAdapterHelper.get(context, convertView, parent, R.item_personal_center_prefix.item)
 *         .setText(R.id.tvName, contact.getItem())
...
public class BaseAdapterHelper {
     ...
     *
     * @param viewId      The view id.
     * @param drawableRes The image res.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageDrawable(int viewId, int drawableRes) {
        ImageView view = retrieveView(viewId);
     ...
     * @param viewId        The view id.
     * @param imageUrl      The image URL.
     * @param errorDrawable Down error show png
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int errorDrawable) {
        ImageView view = retrieveView(viewId);
        Picasso.with(context).load(imageUrl).error(errorDrawable).into(view);
        return this;
    }
     ...
     * @param viewId             The view id.
     * @param imageUrl           The image URL.
     * @param palceholerDrawable Before Down show png
     * @param errorDrawable      Down error show png
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int palceholerDrawable, int errorDrawable) {
        if (imageUrl.equals("") || imageUrl == null) {
            return this;
        }
        ImageView view = retrieveView(viewId);
        Picasso.with(context).load(imageUrl).placeholder(palceholerDrawable).error(errorDrawable).into(view);
        return this;
    }

    public BaseAdapterHelper setImageLoaclResID(int viewId, int drawableRes) {
        ImageView view = retrieveView(viewId);
        Picasso.with(context).load(drawableRes).into(view);
        return this;
    }
    ...
    public BaseAdapterHelper setViewToLinearLayout(int viewId, View view) {
