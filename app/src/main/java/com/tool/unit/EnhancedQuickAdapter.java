 ...
 */
public abstract class EnhancedQuickAdapter<T> extends com.tool.unit.QuickAdapter<T> {

    /**
     * Create a QuickAdapter.
     *
     * @param context     The context.
     * @param layoutResId The item_personal_center_prefix resource id of each item.
     */
