...
public class MVFragment extends BaseFragment implements OnRecyclerItemClickListener, OnClickListener {

    ///used by cache
    public static final String TAG = "MVFragment_tag_loveMV";//
    private final String tag = "loveMV";
    private DbUtils db;

    ///page
    private int pageSize = 10;
    private int pageIndex = 1;
    private String videoType = "4";//MV
    ...
    public void initialize() {
        ...
        networkDialog = new MTDialog.Builder(getActivity())
                ...
                .setOnClickListener(MVFragment.this)
                .create();
...
//        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL);
        ...
        adapter = new MyAdapter(MVFragment.this);
