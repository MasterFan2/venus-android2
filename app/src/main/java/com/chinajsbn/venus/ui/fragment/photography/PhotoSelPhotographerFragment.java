 ...
 * description:
 */
@FragmentFeature(layout = R.layout.fragment_photo_sel_photogrepher)
public class PhotoSelPhotographerFragment extends BaseFragment implements OnRecyclerItemClickListener {
        ...
        viewPager.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView rView, int scrollState) {
                ...
                if (scrollState == RecyclerViewPager.SCROLL_STATE_IDLE && currentHeadSelect != position) {
                    ...
                    recyclerView.setAdapter(new MyAdapter(data.get(position).getList(), PhotoSelPhotographerFragment.this));
                }
            }
...
//        recyclerView.setAdapter(new MyAdapter(null, PhotoSelPhotographerFragment.this));
        //获取数据
        HttpClient.getInstance().getPhotographer(1, 1, 20, cb);
    }
...
//
//                recyclerView.setAdapter(new MyAdapter(data.get(0).getList(), PhotoSelPhotographerFragment.this));
//            }
