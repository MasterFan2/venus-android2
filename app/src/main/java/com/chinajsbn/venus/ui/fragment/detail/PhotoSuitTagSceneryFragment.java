 ...
 * Description :tag Scenery
 */
@FragmentFeature(layout = R.layout.fragment_suit_tag_scenery)
public class PhotoSuitTagSceneryFragment extends BaseFragment implements OnRecyclerItemClickListener {
